...
> now available as a [GitHub Marketplace action](https://github.com/marketplace/actions/medijobs-release)

[![Commits](https://img.shields.io/github/commit-activity/w/R-A-Tech-Innovators/release?style=flat)](https://github.com/R-A-Tech-Innovators/release)
[![Issues](https://img.shields.io/github/issues/R-A-Tech-Innovators/release.svg?style=flat)](https://github.com/R-A-Tech-Innovators/release/issues)
[![Releases](https://img.shields.io/github/v/release/R-A-Tech-Innovators/release.svg?style=flat)](https://github.com/R-A-Tech-Innovators/release/releases)
...
jobs:
  release:
    ...
    steps:
      ...
      - name: "🚀 release"
        id: semantic-release
        uses: R-A-Tech-Innovators/release@v1
        env:
          GITHUB_TOKEN: ${{ secrets.GITHUB_TOKEN }}
          NPM_TOKEN: ${{ secrets.NPM_TOKEN }}
